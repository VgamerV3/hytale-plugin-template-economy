...
Built jars are written to `build/libs/hytale-plugin-template-economy-1.1.0.jar`, with matching sources and javadoc jars next to it.

## Commands
- `/hdeconomydemo`: Runs a demo action for the Economy template.
- `/hdeconomystatus`: Shows runtime status for the Economy template.
...
2. Copy `build/libs/hytale-plugin-template-economy-1.1.0.jar` into your server `plugins/` directory.
