...
public final class EconomyPluginState {
  private final AtomicReference<EconomyPluginLifecycle> lifecycle = new AtomicReference<>(EconomyPluginLifecycle.NEW);
  ...
  private volatile String templateName = "Economy";
  private volatile String dataDirectory = "";

  public EconomyPluginLifecycle getLifecycle() {
    return lifecycle.get();
  }

  public void setLifecycle(EconomyPluginLifecycle next) {
    lifecycle.set(next);
  }
